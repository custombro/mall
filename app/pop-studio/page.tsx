...
const deployMarker = "DEPLOY_POP_WIDE_20260326_003815";

const materialRows = [
  { name: "투명판 5T", state: "기본" },
  { name: "백색판 5T", state: "대체" },
  { name: "인쇄면 추가", state: "선택" }
];
          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
            <div className="space-y-1">
              ...
              <h1 className="text-[30px] font-semibold tracking-tight">
                POP 제작은 큰 작업 테이블 기준으로 본다
              </h1>
            </div>
            <div className="flex items-center gap-3">
              <div className="text-right">
                <p className="text-sm leading-6 text-neutral-600">
                  좌우는 얇게, 중앙은 크게. 전시 구조와 받침 배치를 실제로 보기 쉬운 작업형 구조로 다시 넓혔다.
                </p>
        ...
        <section className="grid gap-4 xl:grid-cols-[190px_minmax(0,1fr)_260px]">
          <aside className="rounded-[28px] border border-black/10 bg-white p-4 shadow-sm">
            ...
            <div className="mt-4 rounded-2xl bg-[#f7f3ed] p-4">
              ...
              <div className="mt-3 space-y-2">
                <div className="rounded-xl bg-white px-3 py-2 text-sm text-neutral-700">투명판 우선</div>
                <div className="rounded-xl bg-white px-3 py-2 text-sm text-neutral-700">받침 구조 확인</div>
          ...
          <section className="rounded-[28px] border border-black/10 bg-white p-4 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-600">
                  POP은 받침과 본체 높이감이 중요하므로 중앙 작업 테이블을 크게 키워 실제 조립 감각이 보이게 했다.
                </p>
              </div>
            ...
            <div className="mt-4 rounded-[34px] border border-black/10 bg-[#ede7de] p-5">
              <div className="relative min-h-[760px] overflow-hidden rounded-[30px] border border-black/10 bg-[#f7f3ed]">
                ...
                <div className="absolute left-[5%] top-[10%] bottom-[14%] w-[20%] rounded-[28px] border border-dashed border-black/10 bg-white/80 p-5">
                ...
                <div className="absolute left-[26%] right-[20%] bottom-[18%] h-[52%] rounded-[34px] border border-black/10 bg-white shadow-sm">
                  ...
                  <div className="absolute left-[31%] bottom-[32%] h-[6%] w-[7%] rounded-full bg-neutral-900" />
                  <div className="absolute left-[47%] bottom-[32%] h-[6%] w-[7%] rounded-full bg-neutral-900" />
                  <div className="absolute left-[63%] bottom-[32%] h-[6%] w-[7%] rounded-full bg-neutral-900" />
